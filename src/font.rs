//! Fuente VGA 8x16 en Rust
//! Convertida desde el array de C

/// Fuente de 8x16 píxeles para caracteres ASCII
/// Cada carácter está representado por 16 bytes, cada byte es una fila de 8 píxeles
...
/// Obtener los datos de un carácter específico
#[inline]
pub fn get_char(c: u8) -> &'static [u8; 16] {
